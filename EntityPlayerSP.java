...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            else
            {
                ...
                EventPostMotionUpdates postMotionUpdates = new EventPostMotionUpdates();
                postMotionUpdates.call();
            }
        }
    }
    ...
    {
        EventPreMotionUpdates preMotionUpdates = new EventPreMotionUpdates(this.rotationYaw, this.rotationPitch, this.onGround);
        preMotionUpdates.call();
