package me.iyoshimc.iowa.ui.font;
...
public class UnicodeFontRender {
    ...
    public UnicodeFontRender(final String fontName, final int fontType, final int size) {
    ...
    public UnicodeFontRender(final Font font) {
        this.mc = Minecraft.getMinecraft();
        this.colorCodes = new int[32];
